...
// Ref - https://www.prisma.io/docs/orm/more/help-and-troubleshooting/help-articles/nextjs-prisma-client-dev-
...
//  and save it on the globalThis object. Then we keep a check to only instantiate PrismaClient
//   if it's not on the globalThis object otherwise use the same instance 
//   again if already present to prevent instantiating extra PrismaClient instances.
